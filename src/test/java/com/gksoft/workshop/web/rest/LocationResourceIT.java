...
import com.gksoft.workshop.domain.Location;
import com.gksoft.workshop.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getLang()).isEqualTo(DEFAULT_LANG);
    ...
    void putExistingLocation() throws Exception {
        ...
        assertThat(testLocation.getLang()).isEqualTo(UPDATED_LANG);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.name(UPDATED_NAME).city(UPDATED_CITY).stateProvince(UPDATED_STATE_PROVINCE).lat(UPDATED_LAT);
