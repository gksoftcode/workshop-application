...
import PaymentCreditUpdateComponent from '@/entities/payment-credit/payment-credit-update.vue';
import PaymentCreditClass from '@/entities/payment-credit/payment-credit-update.component';
...
describe('Component Tests', () => {
  describe('PaymentCredit Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<PaymentCreditClass>(PaymentCreditUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        // GIVEN
        const entity = { id: 123 };
        comp.paymentCredit = entity;
        paymentCreditServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(paymentCreditServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.paymentCredit = entity;
        paymentCreditServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(paymentCreditServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        paymentCreditServiceStub.retrieve.resolves([foundPaymentCredit]);
