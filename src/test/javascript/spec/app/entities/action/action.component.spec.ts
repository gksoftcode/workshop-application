...
describe('Component Tests', () => {
  describe('Action Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      // GIVEN
      actionServiceStub.retrieve.reset();
      comp.previousPage = 1;
      ...
      // THEN
      expect(actionServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(actionServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(actionServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
