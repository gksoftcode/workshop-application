...
import com.gksoft.workshop.service.ActionService;
...
/**
 * REST controller for managing {@link com.gksoft.workshop.domain.Action}.
 */
@RestController
@RequestMapping("/api")
public class ActionResource {
     ...
     */
    @GetMapping("/actions")
    public ResponseEntity<List<Action>> getAllActions(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
