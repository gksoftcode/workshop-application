...
export default class AttachmentNotes extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllAttachmentNotess();
  }
  ...
  public retrieveAllAttachmentNotess(): void {
  ...
  public prepareRemove(instance: IAttachmentNotes): void {
  ...
  public removeAttachmentNotes(): void {
    this.attachmentNotesService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('workshopApp.attachmentNotes.deleted', { param: this.removeId });
