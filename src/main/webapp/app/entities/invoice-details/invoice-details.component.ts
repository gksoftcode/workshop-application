...
export default class InvoiceDetails extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllInvoiceDetailss();
  }
  ...
  public retrieveAllInvoiceDetailss(): void {
  ...
  public prepareRemove(instance: IInvoiceDetails): void {
  ...
  public removeInvoiceDetails(): void {
    this.invoiceDetailsService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('workshopApp.invoiceDetails.deleted', { param: this.removeId });
