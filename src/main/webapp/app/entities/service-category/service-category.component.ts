...
export default class ServiceCategory extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllServiceCategorys();
  }
  ...
  public retrieveAllServiceCategorys(): void {
  ...
  public prepareRemove(instance: IServiceCategory): void {
  ...
  public removeServiceCategory(): void {
    this.serviceCategoryService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('workshopApp.serviceCategory.deleted', { param: this.removeId });
