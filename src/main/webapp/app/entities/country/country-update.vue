  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="workshopApp.country.home.createOrEditLabel"
          data-cy="CountryCreateUpdateHeading"
          v-text="$t('workshopApp.country.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('workshopApp.country.name')" for="country-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
