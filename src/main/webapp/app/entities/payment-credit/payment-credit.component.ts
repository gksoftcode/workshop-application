...
export default class PaymentCredit extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllPaymentCredits();
  }
  ...
  public retrieveAllPaymentCredits(): void {
  ...
  public prepareRemove(instance: IPaymentCredit): void {
  ...
  public removePaymentCredit(): void {
    this.paymentCreditService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('workshopApp.paymentCredit.deleted', { param: this.removeId });
