  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="workshopApp.status.home.createOrEditLabel"
          data-cy="StatusCreateUpdateHeading"
          v-text="$t('workshopApp.status.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('workshopApp.status.name')" for="status-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
