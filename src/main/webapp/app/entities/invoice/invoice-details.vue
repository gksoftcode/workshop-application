    ...
    <div class="col-8">
      <div v-if="invoice">
        ...
        <dl class="row jh-entity-details">
          ...
          <dt>
            <span v-text="$t('workshopApp.invoice.paymentStatus')">Payment Status</span>
          </dt>
          <dd>
            <span v-text="$t('workshopApp.PaymentStatus.' + invoice.paymentStatus)">{{ invoice.paymentStatus }}</span>
          </dd>
          <dt>
