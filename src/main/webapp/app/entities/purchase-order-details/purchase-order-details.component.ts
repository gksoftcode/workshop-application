...
export default class PurchaseOrderDetails extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllPurchaseOrderDetailss();
  }
  ...
  public retrieveAllPurchaseOrderDetailss(): void {
  ...
  public prepareRemove(instance: IPurchaseOrderDetails): void {
  ...
  public removePurchaseOrderDetails(): void {
    this.purchaseOrderDetailsService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('workshopApp.purchaseOrderDetails.deleted', { param: this.removeId });
