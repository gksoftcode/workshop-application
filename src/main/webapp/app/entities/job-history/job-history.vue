<template>
  <div>
    <h2 id="page-heading" data-cy="JobHistoryHeading">
      <span v-text="$t('workshopApp.jobHistory.home.title')" id="job-history-heading">Job Histories</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('workshopApp.jobHistory.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'JobHistoryCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('workshopApp.jobHistory.home.createLabel')"> Create a new Job History </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && jobHistories && jobHistories.length === 0">
      <span v-text="$t('workshopApp.jobHistory.home.notFound')">No jobHistories found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('startDate')">
              <span v-text="$t('workshopApp.jobHistory.startDate')">Start Date</span>
            ...
            <th scope="row" v-on:click="changeOrder('endDate')">
              <span v-text="$t('workshopApp.jobHistory.endDate')">End Date</span>
            ...
            <th scope="row" v-on:click="changeOrder('job.id')">
              <span v-text="$t('workshopApp.jobHistory.job')">Job</span>
            ...
            <th scope="row" v-on:click="changeOrder('department.id')">
              <span v-text="$t('workshopApp.jobHistory.department')">Department</span>
            ...
            <th scope="row" v-on:click="changeOrder('employee.id')">
              <span v-text="$t('workshopApp.jobHistory.employee')">Employee</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="workshopApp.jobHistory.delete.question" data-cy="jobHistoryDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-jobHistory-heading" v-text="$t('workshopApp.jobHistory.delete.question', { id: removeId })">
